...
<nav id="sidebar" class='mx-lt-5 bg-dark' >
		...
		<div class="sidebar-list">
				...
				<div class="collapse" id="collapseExample">
					<a href="index.php?page=quiz_list" class="nav-item nav-quiz_list"> List</a>	
				</div>
				
			<?php elseif($_SESSION['login_type'] == 3): ?>
				<a href="index.php?page=home" class="nav-item nav-home"><span class='icon-field'><i class="fa fa-home"></i></span> Home</a>
				<a href="index.php?page=join_quiz" class="nav-item nav-home"><span class='icon-field'><i class="fa fa-sign-in-alt"></i></span> Join Quiz</a>
			<?php endif; ?>
		</div>
